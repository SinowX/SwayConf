...
cmdline=(mlocate man-db man-pages bash-completion ranger openssh)
develop=(git gcc gdb cmake make docker vim vim-plug powerline-vim nodejs)
...
desktop=(sway dunst waybar wl-paste arc-icon-theme qogir-icon-theme wdisplays clipman swaylock-effects)
